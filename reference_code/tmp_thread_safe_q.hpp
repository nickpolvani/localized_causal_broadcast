...
/*
Code from https://www.educba.com/c-thread-safe-queue/
needs to be modified/reimplemented to see if I can understand this stuff
*/
...
public:
    ...
    void push(T &&data)
    {
        ...
        // Push with lock
        {
            ...
            list.splice(list.end(), tmpl, tmpl.begin());
            // popping thread to wake up
            cvPop.notify_one(); // here there is not the check on curr_size = 1, which makes sense
        }
    }
    // Popping value from Q and write to var
